#include "TrajectoryMars.h"
#include "ProceduralMeshComponent.h"
#include "Engine.h"


ATrajectoryMars::ATrajectoryMars()
{
	ProceduralMeshComponent = CreateDefaultSubobject<UProceduralMeshComponent>(TEXT("ProceduralMeshComponent"));
	RootComponent = ProceduralMeshComponent;
}

void ATrajectoryMars::BeginPlay()
{
	Super::BeginPlay();
	GenerateHollowEllipseMesh();
}

void ATrajectoryMars::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 5800.0f;
	const float OuterRadiusY = 5500.0f;
