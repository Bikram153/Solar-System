#include "TrajectoryNeptune.h"
#include "ProceduralMeshComponent.h"
#include "Engine.h"


ATrajectoryNeptune::ATrajectoryNeptune()
{
	ProceduralMeshComponent = CreateDefaultSubobject<UProceduralMeshComponent>(TEXT("ProceduralMeshComponent"));
	RootComponent = ProceduralMeshComponent;
}

void ATrajectoryNeptune::BeginPlay()
{
	Super::BeginPlay();
	GenerateHollowEllipseMesh();
}

void ATrajectoryNeptune::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 10500.0f;
	const float OuterRadiusY = 10200.0f;
