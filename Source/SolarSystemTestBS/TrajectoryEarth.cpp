#ifndef TRAJECTORYEARTH_H
#define TRAJECTORYEARTH_H
#include "TrajectoryEarth.h"
#include "ProceduralMeshComponent.h"
#include "Engine.h"

ATrajectoryEarth::ATrajectoryEarth()
{
	ProceduralMeshComponent = CreateDefaultSubobject<UProceduralMeshComponent>(TEXT("ProceduralMeshComponent"));
	RootComponent = ProceduralMeshComponent;
}

void ATrajectoryEarth::BeginPlay()
{
	Super::BeginPlay();
	GenerateHollowEllipseMesh();
}

void ATrajectoryEarth::GenerateHollowEllipseMesh()
{
